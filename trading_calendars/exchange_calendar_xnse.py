...
precomputed_nse_holidays = pd.to_datetime([
    '1997-01-23',
    '1997-03-07',
    '1997-03-24',
    '1997-04-08',
...
class XNSExchangeCalendar(PrecomputedTradingCalendar):
    """
    Exchange calendar for the National Stock Exchange, India (NSE, XNSE).
    ...
    def precomputed_holidays(self):
        return precomputed_nse_holidays
